...
const translations = {
    ...
    hy: {
        ...
        'products.unibord625': '<strong>ԹԱՓԱՆՑԻԿ</strong><br>Թափանցիկ EVA տաք հալվող սոսինձ՝ եզրագոտիների ավտոմատ սոսնձման համար, բարձր արտադրողականություն, ջրի և լուծիչների նկատմամբ դիմացկունություն։ Հարմար է փայտի, պոլիեսթերի, մելամինի, պլաստիկի, PVC և ABS եզրաշերտերի համար։ Հարմար է soft-forming և BAZ մշակման կենտրոններում (CNC մեքենաներ) կիրառման համար։<br><br><strong>Փաթեթավորում․</strong> 20 կգ տարրա<br><br>• Թափանցիկ<br>• Soft-forming-ի և BAZ կենտրոնների համար',

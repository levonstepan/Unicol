...
const translations = {
    ...
    hy: {
        ...
        'about.text1': 'Unicol S.r.l.-ը 1977 թվականից ի վեր արտադրում է արդյունաբերական սոսինձներ Իտալիայում: Մենք առաջարկում ենք արտադրանքի լայն տեսականի տարբեր արդյունաբերական սեկտորների համար, ինչպիսիք են փայտամշակումը, վահանակների արտադրությունը, շինարարությունը, տեքստիլի և այլ հյուսվածքների արտադրությունը:',
        ...
        'workshops.text1': 'Roots LLC-ն առաջարկում է համապարփակ վարպետաց դասեր և վերապատրաստման նիստեր՝ օգնելու ձեզ առավելագույնս օգտագործել Unicol արդյունաբերական սոսինձները: Մեր փորձագետ տեխնիկները ապահովում են գործնական վերապատրաստում՝ ընդգրկելով արտադրանքի ընտրություն, կիրառման տեխնիկա և լավագույն պրակտիկաներ օպտիմալ կապակցման արդյունքների համար:',
        'workshops.text2': 'Անկախ նրանից, թե դուք աշխատում եք փայտամշակման, վահանակների արտադրության կամ մասնագիտացված կիրառությունների հետ, մեր վարպետաց դասերը նախագծված են ձեր տեխնիկական գիտելիքները բարելավելու և արտադրական արդյունավետությունը բարձրացնելու համար:',

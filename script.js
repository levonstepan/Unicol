...
const translations = {
    ...
    hy: {
        ...
        'products.resina401': '<strong>ՈւՐԱ-ՖՈՐՄԱԼԴԵՀԻԴԱՅԻՆ ՍՈՍԻՆՁ (UF ՍՈՍԻՆՁ)</strong><br>Ինքնակարծրացվող սոսինձ, բարձր արտադրողականություն, գերազանց լուծելիություն, գերազանց կպչունություն և ցածր արտահոսք։ Օգտագործվում է E1 դասի պանելների արտադրության մեջ։<br><br><strong>Փաթեթավորում․</strong> 25 կգ տարրա<br><br>• E1 դասի արտադրատեսակների համար<br>• Ինքնակարձրացվող<br>• Բարձր արտադրողականություն<br>• Ցածր արտահոսք<br>• Հարմար տաք և բարձր հաճախականությամբ մամլիչների համար',
        ...
        'products.nunivil165': '<strong>ԹԱՓԱՆՑԻԿ</strong><br>Արագ կպչողականությամբ վինիլային դիսպերսիոն սոսինձ, որը կահույքի հավաքման ընթացքում ապահովում է արագ ֆիքսացիա՝ սեղմակները հնարավոր դարձնելով հեռացնել շատ կարճ ժամանակ անց։<br><br><strong>Փաթեթավորում․</strong> 25 կգ տարրա, 1000 կգ տարրա<br><br>• Թափանցիկ<br>• Սուպեր արագ կպչում',
        'products.unipren1070': '<strong>ԿՈՆՏԱԿՏԱՅԻՆ ՍՈՍԻՆՁ</strong><br>Կոնտակտային սոսինձ՝ նախատեսված սպատուլայով (spatula) կիրառման համար։<br><br><strong>Փաթեթավորում․</strong> 12 տարրա × 1.75 կգ, 24 տարրա × 0.85 կգ',
        'products.nunivil25': '<strong>ԿՈՇՏ ՓԱՅՏԵՐԻ ՀԱՄԱՐ</strong><br>Վինիլային դիսպերսիոն սոսինձ՝ հատուկ կոշտ և խեժային փայտատեսակների սոսնձման համար։ Լայնորեն կիրառվում է և հայտնի է իր արագ կպչողականությամբ և թափանցիկ սոսնձագծով։ Ստուգված է CATAS լաբորատորիայում՝ աթոռների արտադրության համար (CREEP TEST)։<br><br><strong>Փաթեթավորում․</strong> 25 կգ տարրա, 1000 կգ տարրա<br><br>• Կոշտ փայտերի համար<br>• Բարձր ներթափանցում փայտի մեջ<br>• Թափանցիկ<br>• Հարմար աթոռների և սեղանների արտադրության համար',
        'products.unibord607m': '<strong>ԿԻՍԱԹԱՓԱՆՑԻԿ</strong><br>EVA հիմքով տաք հալվող սոսինձ՝ բարձր կպչունությամբ և գրեթե անտեսանելի սոսնձագծով։ Հալման արագությունն ու ցածր մածուցիկությունը այս արտադրանքը դարձնում են չափազանց բազմաֆունկցիոնալ։<br><br><strong>Փաթեթավորում․</strong> 25 կգ տարրա<br><br>• Կիսաթափանցիկ<br>• Բարձր կպչունություն<br>• Բարձր արտադրողականություն',
        'products.unibord625': '<strong>ԹԱՓԱՆՑԻԿ</strong><br>Թափանցիկ EVA տաք հալվող սոսինձ՝ եզրագոտիների ավտոմատ սոսնձման համար, բարձր արտադրողականություն, ջրի և լուծիչների նկատմամբ դիմացկունություն։ Հարմար է փայտի, պոլիեսթերի, մելամինի, պլաստիկի, PVC և ABS եզրաշերտերի համար։ Հարմար է soft-forming և BAZ մշակման կենտրոններում (մեքենաներ CNC) կիրառման համար։<br><br><strong>Փաթեթավորում․</strong> 20 կգ տարրա<br><br>• Թափանցիկ<br>• Soft-forming-ի և BAZ կենտրոնների համար',
